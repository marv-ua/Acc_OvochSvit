...
Процедура УправлениеФормой(Форма);
	...
	Если Форма.ОписаниеТипа.СодержитТип(Тип("СправочникСсылка.ДоговорыКонтрагентов")) Тогда
		ПодсказкаВвода = НСтр("ru='Контрагент (владелец договора)';uk='Контрагент (власник договору)'");
		ДоступностьСвязи = Истина;
	ИначеЕсли Форма.ОписаниеТипа.СодержитТип(Тип("СправочникСсылка.БанковскиеСчета")) Тогда
		ПодсказкаВвода = НСтр("ru='Контрагент (владелец банковского счета)';uk='Контрагент (власник банківського рахунку)'");
		ДоступностьСвязи = Истина;
	ИначеЕсли Форма.ОписаниеТипа.СодержитТип(Тип("СправочникСсылка.НазначенияИспользования")) Тогда
		ПодсказкаВвода = НСтр("ru='Номенклатура (владелец назначения использования)';uk='Номенклатура (власник призначення використання)'");
		ДоступностьСвязи = Истина;
	Иначе
		ПодсказкаВвода = "";
