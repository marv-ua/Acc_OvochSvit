...
Процедура Заполнить(ПараметрыЗаполненияЗвит1С)
	...
	Если ЗарплатаКадрыРасширенная Тогда
		...
		МассивВидыВремениРабота = Новый Массив();
		МассивВидыВремениРабота.Добавить(Справочники.ВидыИспользованияРабочегоВремени.РаботаВечерниеЧасы);
		МассивВидыВремениРабота.Добавить(Справочники.ВидыИспользованияРабочегоВремени.РаботаНочныеЧасы);    
		МассивВидыВремениРабота.Добавить(Справочники.ВидыИспользованияРабочегоВремени.РаботаВРежимеНеполногоВремени);      
		МассивВидыВремениРабота.Добавить(Справочники.ВидыИспользованияРабочегоВремени.Явка);
		ЗапросРабочееВремя.УстановитьПараметр("РабочееВремя", МассивВидыВремениРабота);
		...
		|      		И ДанныеУчетаВремениПоСостояниям.ВидУчетаВремени В (&РабочееВремя)
		|
		|СГРУППИРОВАТЬ ПО
