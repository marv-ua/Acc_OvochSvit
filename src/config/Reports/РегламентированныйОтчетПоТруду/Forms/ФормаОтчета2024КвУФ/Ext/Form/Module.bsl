...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	СтруктураРеквизитовФормы.мСоставПоказателей = "СоставПоказателей2024Кв";
...
Процедура РасчетПоказателейКоличестваРаботников(МенеджерВременныхТаблиц)
	...
	Если СтруктураРеквизитовФормы.ЗарплатаКадрыРасширенная Тогда
		...
		КонецЕсли;
		// уволенные по ст.38 и ст.36 п1  КЗоТ
		Запрос.Текст = "ВЫБРАТЬ РАЗЛИЧНЫЕ
		...
		|	ИЛИ СотрудникиОрганизацииУволенные.ПриказОбУвольненииСтатьяКЗоТ = ЗНАЧЕНИЕ(Справочник.ОснованияУвольнения.Статья36п1)";
		Выборка = Запрос.Выполнить().Выбрать();
		Если Выборка.Следующий() Тогда	
		...
		// уволенные по ст.38 и ст.36 п1 КЗоТ женщины
		Запрос.Текст = "ВЫБРАТЬ РАЗЛИЧНЫЕ
