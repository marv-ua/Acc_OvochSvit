...
Процедура Заполнить(ПараметрыЗаполненияЗвит1С, флЗаполнятьПрошлыйПериод)
	...
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П30953", "24",	"+", "!ОБ",ОБ(Счет31,Счет74_6), Счет31,Счет74_6);
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П30953", "23",	"+", "!ОБ",ОБ(Счет30,Счет71_9), Счет30,Счет71_9);
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П30953", "22",	"+", "!ОБ",ОБ(Счет31,Счет71_9), Счет31,Счет71_9);
	
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П30953", "21",	"+", "!ОБ",ОБ(Счет30,Счет68_6), Счет30,Счет68_6);
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П30953", "20",	"+", "!ОБ",ОБ(Счет31,Счет68_6), Счет31,Счет68_6);
	...
	Если флЗаполнятьПрошлыйПериод Тогда	
		...
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П30954", "24",	"+", "!ОБ",ОБ2(Счет31,Счет74_6),Счет31,Счет74_6,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецКвартала(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П30954", "23",	"+", "!ОБ",ОБ2(Счет30,Счет71_9),Счет30,Счет71_9,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецКвартала(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "П30954", "22",	"+", "!ОБ",ОБ2(Счет31,Счет71_9),Счет31,Счет71_9,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецКвартала(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
		
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,  "П30954", "21",	"+", "!ОБ",ОБ2(Счет30,Счет68_6), Счет30,Счет68_6, НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецКвартала(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
		_ДобавитьСтрокуРасшифровки( ЭтаФорма,  "П30954", "20",	"+", "!ОБ",ОБ2(Счет31,Счет68_6), Счет31,Счет68_6, НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецКвартала(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
	...
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "_П31903", "24", "+", "!ОБ", ОБ(Счет68_6,Счет30), Счет68_6,Счет30);
	_ДобавитьСтрокуРасшифровки( ЭтаФорма, "_П31903", "23", "+", "!ОБ", ОБ(Счет68_6,Счет31), Счет68_6,Счет31);
	...
	Если флЗаполнятьПрошлыйПериод Тогда	
		...
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "_П31904", "24", "+", "!ОБ",ОБ2(Счет68_6,Счет30), Счет68_6,Счет30,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецКвартала(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
		_ДобавитьСтрокуРасшифровки( ЭтаФорма, "_П31904", "23", "+", "!ОБ",ОБ2(Счет68_6,Счет31), Счет68_6,Счет31,НачалоГода(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)), КонецКвартала(ДобавитьМесяц(СтруктураРеквизитовФормы.мДатаКонцаПериодаОтчета,-12)));
