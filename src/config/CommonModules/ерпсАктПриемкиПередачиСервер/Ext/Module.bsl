...
Функция ПолучитьРТУ(Идентификатор, Заявка, ПолучатьСсылку = Ложь) Экспорт
...
Функция ОпределитьПунктРазгрузки(Стр) Экспорт
	
	Возврат Справочники.ПунктыРазгрузки.НайтиПоНаименованию(Стр);
