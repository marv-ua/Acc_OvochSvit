...
//++ БУ ЗИК				
//~			ИначеЕсли Руководители.ОтветственноеЛицо = Перечисления.ОтветственныеЛицаОрганизаций.ОтветственныйЗаВУР Тогда
//~				ДанныеОтветственныхЛиц.ОтветственныйЗаВУР    			= Руководители.ФизическоеЛицо;
//~				ДанныеОтветственныхЛиц.ОтветственныйЗаВУРДолжность     	= Руководители.Должность;
//~				ДанныеОтветственныхЛиц.ОтветственныйЗаВУРДолжностьПредставление = Руководители.ДолжностьПредставление;
//~				ДанныеОтветственныхЛиц.ОтветственныйЗаВУРФИО 			= ФИО;
//~				ДанныеОтветственныхЛиц.ОтветственныйЗаВУРПредставление 	= Представление;
//-- БУ ЗИК				
