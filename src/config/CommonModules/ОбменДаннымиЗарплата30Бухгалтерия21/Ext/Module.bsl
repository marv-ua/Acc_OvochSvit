...
// Определяет используется ли обмен Зарплата 3 - Бухгалтерия 2.1 для данных конкретной организации
//
// Параметры
//	Организация
...
Процедура РегистрацияИзмененияДляНачальнойВыгрузки(Получатель, СтандартнаяОбработка, Данные) Экспорт
	...
	Для Каждого ЭлементСоставаПланаОбмена Из СоставПланаОбмена Цикл
		...
		Если ОбщегоНазначения.ЭтоСправочник(ОбъектМетаданных) Тогда
			...
			ИначеЕсли ОбъектМетаданных = Метаданные.Справочники.СпособыОтраженияЗарплатыВРеглУчете Тогда
	...
	Если ВыгружатьПерсональныеДанныеФизическихЛиц Или ОбъектМетаданных = Метаданные.Документы.ОтражениеЗарплатыВБухучете Тогда	
