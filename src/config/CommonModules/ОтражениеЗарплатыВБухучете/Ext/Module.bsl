...
Процедура ЗарегистрироватьОбработчикиОбновления(Обработчики) Экспорт
	...
	Обработчик.Процедура = "ОтражениеЗарплатыВБухучете.ЗаполнениеГруппУчета";
	
КонецПроцедуры

Процедура ЗаполнениеГруппУчета() Экспорт
	
	Обработки.НачальноеЗаполнениеИОбновлениеОбъектов.ЗаполнитьОбъект("Справочник", "ГруппыУчетаНачисленийИУдержаний",,Истина);	
