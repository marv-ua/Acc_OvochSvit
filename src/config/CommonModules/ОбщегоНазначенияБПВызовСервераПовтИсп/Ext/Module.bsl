...
Функция ПолучитьДатуНачалаИспользованияСчетаРозничнаяВыручкаВКассахККМ() Экспорт
	
	// он же "Наличные деньги в национальной валюте по операциям, проведенным с использованием РРО"
	Возврат '20240223';
