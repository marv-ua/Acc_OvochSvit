...
Процедура СохранитьНастройки() 
	...
	Если СписокПИБ.Количество()=0 Тогда
		Сообщить(НСтр("ru='Недостаточно прав для записи настроек';uk= 'Недостатньо прав для запису настройок'"));
		Возврат;
	КонецЕсли;
...
&НаКлиенте
Процедура НастройкаВыводаРеквизитов(Команда)
	ОткрытьФорму("Обработка.Пактум_Настройка.Форма.ФормаНастройкаВыводаРеквизитов");
КонецПроцедуры
