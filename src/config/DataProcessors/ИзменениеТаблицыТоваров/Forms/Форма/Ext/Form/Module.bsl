...
Процедура ВыполнитьДействие(Команда)
	...
	Если ТекущееДействие = "ДобавитьИзДокумента" Тогда   		
		...
		Если ТипЗнч(ВариантЗначенияДокумент)= Тип("СписокЗначений") Тогда
			Для Каждого ДокументИсточник из ВариантЗначенияДокумент Цикл 		
				ДобавитьДанныеИзДокумента(ДокументИсточник.Значение);
			КонецЦикла;
		Иначе
...
Процедура ЗаполнитьОграниченияТипаПолейВводаВариантаЗначения()
	...
	//<TVladimir=МножВыбор>  (03.11.2020)
	МассивНужныхТипов.Добавить(Тип("СписокЗначений"));
...
Процедура ОбработкаОповещения(ИмяСобытия, Параметр, Источник)
	Если ИмяСобытия = "МножВыбор" Тогда
		ВариантЗначенияДокумент = Новый СписокЗначений;
		ВариантЗначенияДокумент.ЗагрузитьЗначения(Параметр);
	КонецЕсли;
КонецПроцедуры

&НаКлиенте
Процедура ВариантЗначенияДокументОбработкаВыбора(Элемент, ВыбранноеЗначение, СтандартнаяОбработка)
	Если ВыбранноеЗначение = Тип("ДокументСсылка.РеализацияТоваровУслуг") Тогда
		СтандартнаяОбработка = Ложь;
