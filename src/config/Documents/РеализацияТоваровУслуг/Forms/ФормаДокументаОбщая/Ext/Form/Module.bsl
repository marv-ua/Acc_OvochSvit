...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если РольДоступна("ЕРПССогласованиеРеализации") Тогда
		Элементы.Погоджено.Доступность = Истина;
	КонецЕсли;	
...
Процедура ТоварыПриИзменении(Элемент)
	...
	//ерпс
	Объект.ерпсВес = Объект.Товары.Итог("Количество");
	//...ерпс
...
//ЕРПС.Кононенко
&НаСервере
Процедура ПроверитьСогласование()
	Если Объект.Погоджено И Не РольДоступна("ЕРПССогласованиеРеализации") Тогда
...
Процедура ДобавитьРеквизитыНаФорму()
	...
	НовыйЭлемент = Элементы.Добавить("а_Периоды", Тип("ПолеФормы"), Элементы.ГруппаШапкаЛевая);
    НовыйЭлемент.ПутьКДанным                  = "Объект.а_Периоды";
