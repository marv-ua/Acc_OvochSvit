...
Процедура ПунктыРазгрузкиПунктРазгрузкиПриИзменении(Элемент)
	ЗаполнитьКонтактнымиДанными(Элементы.ПунктыРазгрузки.ТекущаяСтрока, Объект);
...
Процедура ПунктыРазгрузкиВодительПриИзменении(Элемент)
	ЗаполнитьДаннымиСотрудника(Элементы.ПунктыРазгрузки.ТекущаяСтрока, Объект);
КонецПроцедуры
...
&НаСервереБезКонтекста
Процедура ЗаполнитьДаннымиСотрудника(НомерСтроки = Неопределено, Об)
