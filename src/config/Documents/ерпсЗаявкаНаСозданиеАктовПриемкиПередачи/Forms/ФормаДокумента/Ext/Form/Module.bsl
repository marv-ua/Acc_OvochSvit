...
Процедура ПослеВопросаЗагрузитьЗаявкуХарьковская_Завершение(Результат, ДопПараметры) Экспорт
    ...
    ОбработкаОкончанияПомещения = Новый ОписаниеОповещения("ОбработчикОкончанияПомещенияЗаявкиХарьковская", ЭтотОбъект);
...
Процедура ОбработчикОкончанияПомещенияЗаявкиХарьковская(Результат, Адрес, ВыбранноеИмяФайла, ДополнительныеПараметры) Экспорт
	...
	Если Результат Тогда
		...
		ОбработатьЗаявкуХарьковскаяНаСервере(Адрес, УникальныйИдентификатор);
...
&НаСервере
Процедура ОбработатьЗаявкуХарьковскаяНаСервере(Адрес, УникальныйИдентификатор)
