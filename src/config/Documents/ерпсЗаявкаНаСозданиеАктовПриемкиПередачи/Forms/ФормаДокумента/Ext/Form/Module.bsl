...
Процедура ПунктыРазгрузкиПередУдалением(Элемент, Отказ)
	...
	Если Модифицированность Тогда
		ОбщегоНазначенияКлиентСервер.СообщитьПользователю("Збережіть документ, закрийте його та перезайдіть в докумнт");
	Иначе
...
Процедура СоздатьЗаявкиНаСервере(Успешно)
	...
	// Test}
	тзРодитель.Свернуть("ДатаОтгрузки, ПунктРазгрузки, Склад, Регион");
	...
	тзРодитель.Свернуть("ДатаОтгрузки,Склад,Регион");
