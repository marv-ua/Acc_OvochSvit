...
Процедура СписокВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	...
	//...ерпсНикодаЕвгений 2021-10-12
	Если Поле.Имя = "НаличиеОригинала" Или Поле.Имя = "ПолученоВ_ЭлектронномВиде" ИЛИ Поле.Имя = "СвереноПН" Тогда
...
Функция СписокВыбор_ИзменитьРеквизит(Ссылка,Имя)
	...
	Если Имя <> "СвереноПН" Тогда
		//...ерпсНикодаЕвгений 2021-10-12
		Если Не ЗначениеЗаполнено(Ссылка) Или (Имя <> "НаличиеОригинала" И Имя <> "ПолученоВ_ЭлектронномВиде") Тогда
