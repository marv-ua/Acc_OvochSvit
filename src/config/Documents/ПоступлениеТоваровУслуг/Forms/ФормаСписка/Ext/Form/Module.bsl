...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.СвереноПН.Доступность = ПроверкаСвереноПН();
	//...ерпсНикодаЕвгений 2021-10-12
...
Процедура СписокВыбор(Элемент, ВыбраннаяСтрока, Поле, СтандартнаяОбработка)
	//ерпсНикодаЕвгений 2021-10-12
	//Если Поле.Имя = "НаличиеОригинала" Или Поле.Имя = "ПолученоВ_ЭлектронномВиде" Тогда
	//...ерпсНикодаЕвгений 2021-10-12
	Если Поле.Имя = "НаличиеОригинала" Или Поле.Имя = "ПолученоВ_ЭлектронномВиде" ИЛИ Поле.Имя = "СвереноПН" ИЛИ Поле.Имя = "ЕстьТТН" Тогда
		
		СтандартнаяОбработка = Ложь;
		рез = СписокВыбор_ИзменитьРеквизит(ВыбраннаяСтрока,Поле.Имя);
		Если ТипЗнч(рез) = Тип("Булево") Тогда
			//ерпсНикодаЕвгений 2021-10-12
			Если  Поле.Имя = "СвереноПН" Тогда
				Элемент.ТекущиеДанные[Поле.Имя] = рез;
...
&НаСервере
Функция СписокВыбор_ИзменитьРеквизит(Ссылка,Имя)
	//ерпсНикодаЕвгений 2021-10-12
	Если Имя <> "СвереноПН" Тогда
		//...ерпсНикодаЕвгений 2021-10-12
		Если Не ЗначениеЗаполнено(Ссылка) Или (Имя <> "НаличиеОригинала" И Имя <> "ПолученоВ_ЭлектронномВиде" И Имя <> "ЕстьТТН") Тогда
...
Функция ПроверкаСвереноПН()
	...
	Если РольДоступна("ЕРПССогласованиеРеализации") Тогда
		Возврат Истина;
	Иначе
		Возврат Ложь;
	КонецЕсли;
