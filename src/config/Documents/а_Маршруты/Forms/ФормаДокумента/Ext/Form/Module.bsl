...
Функция ПечатьЗаявкиНаСервере(Водитель, Авто, ДатаОтгрузки)
	...
	Возврат Документы.ерпсЗаявкаНаСозданиеАктовПриемкиПередачи.Печать_ОтчетПоЗаявкам(
		М,
		Неопределено,
		Новый Структура("Водитель,Авто,ДатаВывоза,ПунктыРазгрузки", Водитель, Авто, ДатаОтгрузки, Объект.ПунктыРазгрузки.Выгрузить(,"ПунктРазгрузки").ВыгрузитьКолонку("ПунктРазгрузки")),
...
Процедура СортировкаГрупповая()
	...
	Объект.ПунктыРазгрузки.Сортировать("ПунктРазгрузки,ДатаОтгрузки,Количество,Водитель");
