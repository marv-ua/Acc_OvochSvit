...
Процедура ДополнитьСтруктуруПолейТабличнойЧастиНМАРегл(СтруктураШапкиДокумента, СтруктураПолей)
	...
	СтруктураПолей.Вставить("ПервоначальнаяСтоимостьБУ"						, "ПервоначальнаяСтоимостьБУ");
	СтруктураПолей.Вставить("ПервоначальнаяСтоимостьНУ"						, "ПервоначальнаяСтоимостьНУ");
	СтруктураПолей.Вставить("ВключитьНачислениеАмортизации"					, "ВключитьНачислениеАмортизации");
...
Процедура ДополнитьТабличнуюЧастьСведениямиОбПервоначальныхСведенияхНМА(ДатаДока, ТекОрганизация, ТаблицаПоНМА) Экспорт
	...
	|	ПервоначальныеСведенияБУ.ПервоначальнаяСтоимость КАК ПервоначальнаяСтоимостьБУИзРегистра,
	|	ПервоначальныеСведенияНУ.ПервоначальнаяСтоимостьНУ КАК ПервоначальнаяСтоимостьНУИзРегистра,
	|	ПервоначальныеСведенияБУ.НачислятьАмортизацию КАК НачислятьАмортизациюБУИзРегистра,
	|	ПервоначальныеСведенияНУ.НачислятьАмортизацию КАК НачислятьАмортизациюНУИзРегистра,
	...
	Для Каждого СтрокаТЧ Из ТаблицаПоНМА Цикл
		...
		Если СтрокаСведений <> Неопределено Тогда
			...
			Если СтрокаТЧ.ПервоначальнаяСтоимостьБУ = 0 Тогда
				СтрокаТЧ.ПервоначальнаяСтоимостьБУ = СтрокаСведений.ПервоначальнаяСтоимостьБУИзРегистра;
			КонецЕсли;
			Если СтрокаТЧ.ПервоначальнаяСтоимостьНУ = 0 Тогда
				СтрокаТЧ.ПервоначальнаяСтоимостьНУ = СтрокаСведений.ПервоначальнаяСтоимостьНУИзРегистра;
			КонецЕсли;
			Если СтрокаТЧ.ВключитьНачислениеАмортизации = Истина Тогда
				СтрокаТЧ.НачислятьАмортизациюБУ = Истина;
				СтрокаТЧ.НачислятьАмортизациюНУ = Истина;
			Иначе
				СтрокаТЧ.НачислятьАмортизациюБУ = СтрокаСведений.НачислятьАмортизациюБУИзРегистра;
				СтрокаТЧ.НачислятьАмортизациюНУ = СтрокаСведений.НачислятьАмортизациюНУИзРегистра;
			КонецЕсли;
		КонецЕсли;
