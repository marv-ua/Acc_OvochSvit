...
Процедура ЗаполнитьДляСпискаНМАСервер()
	...
	Для каждого СтрокаТЧ Из Объект.НМА Цикл
		...
		Если СтрокаТЗ = Неопределено Тогда
			...
			СтрокаТЧ.ПервоначальнаяСтоимостьБУ                 		= 0;
			СтрокаТЧ.ПервоначальнаяСтоимостьНУ                 		= 0;
		...
		Иначе
			...
			СтрокаТЧ.ПервоначальнаяСтоимостьБУ                 		= СтрокаТЗ.ПервоначальнаяСтоимостьБУ;
			СтрокаТЧ.ПервоначальнаяСтоимостьНУ                 		= СтрокаТЗ.ПервоначальнаяСтоимостьНУ;
